...
class JMTextRpcClient
{
    ...
    */
    public function getTraceLogger()
    {
        ...
        $logdir = isset($config['trace_log_path']) ? $config['trace_log_path'] : '/Users/haolin/work/logs/monitor';
...
if (false) {
    $config = array(
        ...
        'monitor_log_path'  => '/Users/haolin/work/logs/monitor',
        'trace_log_path'    => '/Users/haolin/work/logs/monitor',
        'exception_log_path'=> '/Users/haolin/work/logs/monitor',
        'User' => array(
