...
class ThriftWorker extends PHPServerWorker
{
    ...
    public function onServe()
    {
        ...
        $logdir = PHPServerConfig::get('trace_log_path') ? PHPServerConfig::get('trace_log_path') : '/Users/haolin/work/logs/monitor';
        $config = array(
                        'on' => $on,
                        'app' => self::$appName,
                        'logdir' => $logdir,
        ...
        $logdir = PHPServerConfig::get('exception_log_path') ? PHPServerConfig::get('exception_log_path') : '/Users/haolin/work/logs/monitor';
        $config = array(
                        'on' => $on,
                        'app' => self::$appName,
                        'logdir' => $logdir
